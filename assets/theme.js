...
theme.MobileNav = (function() {
  ...
  // Get the menu modal
var mModalW = document.getElementById("menuModal-women");
var mModalM = document.getElementById("menuModal-men");
var mModalF = document.getElementById("menuModal-futurethought");

// Get the button that opens the menu modal
var btnW = document.getElementById("menuBtn-women");
var btnM = document.getElementById("menuBtn-men");
var btnF = document.getElementById("menuBtn-futurethought");

// Get the <span> element that closes the modal
var span = document.getElementsByClassName("menu-modal-close")[0];

// When the user clicks on the button, open the menu modal
btnW.onclick = function() {
  mModalW.style.display = "block";
  mModalM.style.display = "none";
  mModalF.style.display = "none";
}
btnM.onclick = function() {
  mModalW.style.display = "none";
  mModalM.style.display = "block";
  mModalF.style.display = "none";
}
btnF.onclick = function() {
  mModalW.style.display = "none";
  mModalM.style.display = "none";
  mModalF.style.display = "block";
}

// When the user clicks on <span> (x), close the menu modal
...
// When the user clicks anywhere outside of the menu modal, closes it
window.onclick = function(event) {
  if (event.target == mModalW || event.target == mModalM || event.target == mModalF) {
    mModalM.style.display = "none";
    mModalW.style.display = "none";
    mModalF.style.display = "none";
  }
